...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        if (usuario === "ivan" && contrasena === "123") {
            // Asumimos que el rol es "Administrador" directamente
            Swal.fire({
                icon: "success",
            ...
            localStorage.setItem("usuario", "Ivan");
            localStorage.setItem("rol", "Administrador");
            localStorage.setItem("token", "dummy_token_for_ivan");
